...
object p5Global extends js.Any {
  ...
  def plane(width: Double, height: Double): p5Object = js.native
  ...
  def smooth(): p5Object = js.native

  def strokeWeight(weight: Double): p5Object = js.native
  ...
  def rotate(angle: Double): p5Object = js.native

  def shearX(angle: Double): p5Object = js.native

  def shearY(angle: Double): p5Object = js.native

  def translate(x: Double, y: Double): p5Object = js.native
